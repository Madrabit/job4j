...
@SuppressWarnings({"ArraysAsListWithZeroOrOneArgument", "RedundantCollectionOperation"})
public class IteratorOfIteratorsTest {
    ...
    public void hasNextShouldReturnFalseInCaseOfEmptyIterators() {
        @SuppressWarnings("RedundantCollectionOperation") Iterator<Integer> it1 = (new ArrayList<Integer>()).iterator();
